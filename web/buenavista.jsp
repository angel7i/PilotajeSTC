...
<head>
  ...
  <title>Sistem de Monitoreo de Armario de Pilotaje Automático</title>
...
<section id="main-content">
  <section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Buenavista</h3>
    <div class="row">
      <div class="col-md-12">
      ...
      <table class="table table-hover" id="t1">
        <h4><i class="fa fa-angle-right"></i> Estado actual de las señales estación Buenavista</h4>
        <hr>
        <thead>
        <tr>
          <th>Nombre</th>
